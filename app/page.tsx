  ...
  return (
    <main className="min-h-screen bg-zinc-100 text-zinc-900">
      <div className="mx-auto w-full max-w-5xl px-3 py-5 sm:px-5 sm:py-8">
        <section className="mb-5 rounded-xl border border-zinc-200 bg-white p-4 sm:p-6">
          ...
          {newsflash.length > 0 ? (
            <ul className="space-y-2 text-sm text-zinc-700">
              {newsflash.map((item, index) => (
                <li key={`${item}-${index}`} className="rounded-lg border border-zinc-200 bg-zinc-50 px-3 py-2.5">
                  {item}
                </li>
              ))}
            </ul>
        ...
        <section className="mb-5 grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-4">
          {statCards.map((card) => (
            <article
              key={card.title}
              className="rounded-xl border border-zinc-200 bg-white p-4 transition hover:-translate-y-0.5 hover:border-zinc-400"
            >
              ...
              {recentMatches.map((match) => {
                ...
                return (
                  <Link
                    ...
                    className="rounded-lg border border-zinc-200 bg-zinc-50 p-3 transition hover:border-zinc-400"
                  >
        ...
        <section className="rounded-xl border border-zinc-200 bg-white p-4 sm:p-6">
          ...
          <div className="grid gap-3 md:grid-cols-3">
            {[
              ...
              <article key={ranking.title} className="rounded-lg border border-zinc-200 bg-zinc-50 p-3.5">
          ...
          <div className="mt-4 flex flex-wrap gap-2.5 text-sm">
            <Link
              href="/admin/matches"
              className="rounded-lg border border-zinc-300 bg-zinc-900 px-3.5 py-2 text-zinc-100 transition hover:bg-zinc-700"
            >
              Matches verwalten
            </Link>
            <Link
              href="/admin/stats"
              className="rounded-lg border border-zinc-300 bg-white px-3.5 py-2 text-zinc-800 transition hover:border-zinc-500"
            >
              Mehr Statistiken
            </Link>
            <Link
